...
<head>
    <meta charset="UTF-8">
    <title>Perpustakaan BKKBN || Membaca menjadi lebih mudah!</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <center><b>Selamat Datang di Perpustakaan bkkbn, Untuk Login silahkan klik Icon User atau klik <a href="login.html">disini</a></b></center>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Perpustakaan bkkbn</h4>
                </div>
                <div class="modal-body">
                    <p> Perpustakaan bkkbn adalah salah satu layanan bagi pengguna untuk dapat mengakses berbagai buku bacaan yang dan dilakukan kapan saja dan dari mana saja, dengan menggunakan jaringan internet.</p>
                    <p> Perpustakaan bkkbn memiliki koleksi buku dalam bentuk format digital dan bisa diakses dengan komputer. koleksi bacaan dari Perpustakaan bkkbn dapat diakses dengan cepat dan mudah lewat jaringan komputer.</p>
                    <p> Perpustakaan bkkbn bebasis website yang responsif, untuk info, saran, maupun kritik bisa menghubungi kami :</p>
                    <table>
                        <tr>
                            <td>E-mail</td>
                            <td>:</td>
                            <td><a href="">Perpustakaanbkkbn@gmail.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Blog</td>
